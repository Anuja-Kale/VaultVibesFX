...
public class TransactionsDAO extends DatabaseConnectionFactory {
	...
	public static boolean createNewTransaction(String userId, Transaction transaction) {
		...
		if (isCardTransaction) {
			CREATE_NEW_TRANSACTION_QUERY = "INSERT INTO " + "vaultvibesdb.transactions(" + "transaction_id, "
	...
	public static List<Transaction> getUserTransactions(String userId) {
		...
		try {
			final String GET_TRANSACTIONS_QUERY = "SELECT * " + "FROM vaultvibesdb.transactions " + "WHERE user_id = '"
					+ userId + "';";
	...
	public static List<Transaction> getTransactionsByCardNumber(long cardNumber) {
		...
		final String GET_TRANSACTIONS_QUERY = "SELECT * " + "FROM vaultvibesdb.transactions " + "WHERE card_number = "
	...
	public static List<Transaction> getTransactionsByAccountNumber(long accountNumber) {
		...
		final String GET_TRANSACTIONS_QUERY = "SELECT * " + "FROM vaultvibesdb.transactions " + "WHERE account_number = "
	...
	public static Transaction getTransaction(String transactionId) {
		...
		try {
			final String GET_TRANSACTION_QUERY = "SELECT * " + "FROM vaultvibesdb.transactions "
	...
	public static Transaction getTransactionByDate(String userId, Timestamp transactionTimestamp) {
		...
		Transaction transaction = null;
		try {
			final String GET_TRANSACTION_QUERY = "SELECT * " + "FROM vaultvibesdb.transactions " + "WHERE user_id = '"
	...
	public static Date getLastDueDate(String userId) {
		...
		Transaction transaction = null;
		try {
			final String GET_TRANSACTION_QUERY = "SELECT due_date " + "FROM vaultvibesdb.transactions "
...
//		
//		final String UPDATE_PAYMENT_STATUS_QUERY = "UPDATE vaultvibesdb.transactions " 
...
//	}
	...
	public static boolean updateTransactionsPaymentStatus(String userId) {
		...
		try {
			...
			final String GET_UNPAID_TRANSACTIONS_QUERY = "SELECT * " + "FROM vaultvibesdb.transactions "
...
//				}
	...
	public static boolean updateTransactionPaymentStatus(String userId, String transactionId, String paymentStatus) {
		...
		final String UPDATE_PAYMENT_STATUS_QUERY = "UPDATE vaultvibesdb.transactions " + "SET payment_status = '"
	...
	public static Date getLastPaymentDate(String userId) throws SQLException {
		...
		final String GET_LAST_PAYMENT_DATE_QUERY = "SELECT created_at " + "FROM vaultvibesdb.transactions "
