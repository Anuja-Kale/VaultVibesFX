...
public class AccDepositAnchorPaneController extends Controller implements Initializable {
	@FXML
				...
				if (paymentStatus == PaymentStatus.SUCCESS) {
					...
					if (insufficientFundsAttemptsCount == 2 || invalidOTPAttemptsCount == 2
						...
						if (paymentStatus == PaymentStatus.INSUFFICIENT_FUNDS) {
							...
							contentText = "Try again with different amount or account." + " Attempts Remaining : "
